...
Настройка задержки выдачи контента
-----------------------------------
В основной настройке проекта в поле "Лаг-задержка в днях" выставляем число. Расчет такой: берем текущую дату и отнимаем число - получается промежуток дней.
Те идеи, дата создания которых ложится в этот промежуток, не участвуют в выдаче незарегистрированным пользователям.